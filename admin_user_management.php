        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container mt-5">
                    ...
                    <!-- Add User Button -->
                    <a href="admin_add_user.php" class="btn btn-primary mb-3">Add User</a>
                    ...
                    if (isset($users)) {
                        ...
                        foreach ($users as $user) {
                            ...
                            echo '<td>
                                    <a href="admin_edit_user.php?user_id=' . $user['user_id'] . '" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="backend/admin_delete_user_process.php?user_id=' . $user['user_id'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this user?\')">Delete</a>
                                </td>';
                            echo '</tr>';
                        }
