...
<body>
    ...
    <div class="container-fluid">
        ...
        <!-- Add aircon Button -->
        <a href="staff_add_aircon.php" class="btn btn-primary mb-3">Add Aircon Type</a>
        ...
        if (isset($aircons)) {
            ...
            foreach ($aircons as $aircon) {
                ...
                echo '<td>
                        <a href="staff_edit_aircon.php?id=' . $aircon['id'] . '" class="btn btn-warning btn-sm">Edit</a>
                        <a href="backend/staff_delete_aircon_process.php?id=' . $aircon['id'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this aircon?\')">Delete</a>
                    </td>';
                echo '</tr>';
            }
