        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="padding-bottom: 20px;">
                ...
                <?php
                    ...
                    echo "<canvas id='bookingPieChart' width='500' height='500'></canvas>";
                ...
                <?php
                    ...
                    // Generate Chart.js pie graph
                    echo "<canvas id='bookingPieChart1' width='500' height='500'></canvas>";
                ...
                <?php
                    ...
                    // Generate Chart.js pie graph
                    echo "<canvas id='manpowerPieChart2' width='500' height='500'></canvas>";
