            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                if ($approvedBookingsResult && mysqli_num_rows($approvedBookingsResult) > 0) {
                    ...
                    while ($approvedBooking = mysqli_fetch_assoc($approvedBookingsResult)) {
                        ...
                        echo '<td>';
                        echo '<a href="backend/admin_done_booking_process.php?booking_id=' . $approvedBooking['booking_id'] . '" class="btn btn-success btn-sm' . ($isToday ? '' : ' disabled') . '">Done</a>';
                        echo '<a href="backend/admin_cancel_booking_process.php?booking_id=' . $approvedBooking['booking_id'] . '" class="btn btn-danger btn-sm">Cancel</a>';
                        echo '</td>';
                        echo '</tr>';
                    }
