...
if (mysqli_query($conn, $sql)) {
    ...
    try {
        ...
        $mail->Body = 'Click the following link to verify your email: <a href="http://localhost/aircon/backend/auth/verify_process.php?code=' . $verification_code . '">Verify Email</a>';
